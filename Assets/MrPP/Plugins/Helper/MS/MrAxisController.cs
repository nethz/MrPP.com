...
namespace MrPP.Helper
{
    ...
    /// </summary>
    public class MrAxisController : MonoBehaviour
    {
        /// <summary>
        ...
        public MrButtonController.ButtonType buttonType = MrButtonController.ButtonType.None;
        ...
        private void Awake()
        {
            ...
            {
                if (this.buttonType == MrButtonController.ButtonType.Control)
                {
                    this.buttonType = MrButtonController.ButtonType.Left;
                    Debug.LogWarning("Running under Remote Desktop, so changed AxisContol method to Left mouse button");
                }
                if (this.buttonType == MrButtonController.ButtonType.Alt)
                {
                    this.buttonType = MrButtonController.ButtonType.Right;
                    Debug.LogWarning("Running under Remote Desktop, so changed AxisContol method to Right mouse button");
                }
                if (this.buttonType == MrButtonController.ButtonType.Shift)
                {
                    this.buttonType = MrButtonController.ButtonType.Middle;
        ...
        {
            if (this.buttonType <= MrButtonController.ButtonType.Middle)
            {
                // if mouse button is either left, right or middle
                SetWantsMouseJumping(true);
            }
            else if (this.buttonType <= MrButtonController.ButtonType.Focused)
            {
        ...
        public bool ShouldControl()
        {
            ...
            else if (this.buttonType == MrButtonController.ButtonType.None)
            {
                return true;
            }
            else if (this.buttonType <= MrButtonController.ButtonType.Middle)
            {
                return Input.GetMouseButton((int)this.buttonType);
            }
            else if (this.buttonType == MrButtonController.ButtonType.Control)
            {
                return Input.GetKey(KeyCode.LeftControl) || Input.GetKey(KeyCode.RightControl);
            }
            else if (this.buttonType == MrButtonController.ButtonType.Shift)
            {
                return Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift);
            }
            else if (this.buttonType == MrButtonController.ButtonType.Alt)
            {
                return Input.GetKey(KeyCode.LeftAlt) || Input.GetKey(KeyCode.RightAlt);
            }
            else if (this.buttonType == MrButtonController.ButtonType.Space)
            {
                return Input.GetKey(KeyCode.Space);
            }
            else if (this.buttonType == MrButtonController.ButtonType.Return)
            {
            ...
            else if (this.buttonType == MrButtonController.ButtonType.Focused)
            {
                if (!this.usingMouse)
                {
                    ...
                    return Input.GetMouseButtonDown((int)MrButtonController.ButtonType.Left)
                        || Input.GetMouseButtonDown((int)MrButtonController.ButtonType.Right)
                        || Input.GetMouseButtonDown((int)MrButtonController.ButtonType.Middle);
                }
                else
                {
