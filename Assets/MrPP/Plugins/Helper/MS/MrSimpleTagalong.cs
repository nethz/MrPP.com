...
namespace MrPP.Helper
{
    ...
    /// </summary>
    [RequireComponent(typeof(BoxCollider), typeof(MrInterpolator))]
    public class MrSimpleTagalong : MonoBehaviour
    {
        ...
        // transform.position.
        protected MrInterpolator interpolator;
        ...
        protected virtual void Start()
        {
            ...
            interpolator = gameObject.GetComponent<MrInterpolator>();
